...
/*
注意：
由于直接引入var WebDNN = require("./webdnn")报错
我做了更改,涉及到的判断全部设为 false，原来的代码注释掉了
error：
```
 ...
 * @protected
 */
const IS_WEBGPU_SUPPORTED = false;//'WebGPURenderingContext' in window && 'WebGPUComputeCommandEncoder' in window;
 ...
 * @private
 */
const IS_IOS = false;//navigator.userAgent.includes('iPhone');
/**
 * @protected
 */
