...
class WebGLHandler {
    ...
    static initializeWebGL2Context(canvas = Canvas.createCanvas(288, 288)) {//document.createElement('canvas')) {
        let gl;
    ...
    static initializeWebGL1Context(canvas = Canvas.createCanvas(288, 288)) {//document.createElement('canvas')) {
    ...
    static initializeContext() {
        let canvas = Canvas.createCanvas(288, 288);//document.createElement('canvas');
        let gl;
