...
function getImageArrayFromDrawable(drawable, options = {}) {
    ...
    else if (drawable instanceof canvas_2.ImageData) {
...
function setImageArrayToCanvas(array, imageW, imageH, canvas, options = {}) {
    ...
    image_data_1.setImageDataToCanvas(new canvas_2.ImageData(data, srcW, srcH), canvas, { srcX, srcY, srcW, srcH, dstX, dstY, dstW, dstH });
}
