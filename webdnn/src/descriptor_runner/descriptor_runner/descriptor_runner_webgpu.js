 ...
 * @protected
 */
class DescriptorRunnerWebGPU extends descriptor_runner_1.DescriptorRunner {
    constructor() {
        super(...arguments);
        /**
         * backend name
...
using namespace metal;
    ...
    async initializeStaticBuffer(weightRawArray) {
        ...
        let staticBuffer = new buffer_webgpu_1.default(descriptor.memory_layout.static.size * Float32Array.BYTES_PER_ELEMENT);
        this.staticBuffer = staticBuffer;
        let decoder = get_weight_decoder_1.default(descriptor.weight_encoding);
    ...
    async initializeMetaBuffers() {
        ...
        this.metaBuffers = await Promise.all(this.descriptor.exec_infos.map(async (executionInfo) => {
            let buffer = new buffer_webgpu_1.default(executionInfo.meta_buffer.length * Int32Array.BYTES_PER_ELEMENT);
    ...
    async initializeDynamicBuffer() {
        ...
        let dynamicBuffer = new buffer_webgpu_1.default(dynamicBufferSize * Float32Array.BYTES_PER_ELEMENT);
